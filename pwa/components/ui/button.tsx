    ...
    'disabled:pointer-events-none disabled:cursor-not-allowed',
  {
    variants: {
      ...
      size: {
        ...
        // (DESIGN_BRIEF §13, y §12 «Densidad»: espaciado generoso).
        // El botón de envío del resumen mide 52 px (README.handoff §3).
        default: 'h-[48px] px-s4 text-cuerpo',
        sm: 'h-[48px] px-s3 text-cuerpo',
        dialogo: 'h-[52px] w-full px-s4 text-cuerpo',
        login: 'h-[52px] w-full px-s4 text-cuerpo',
        icon: 'h-12 w-12 p-0',
      },
    },
